...
This PR installs the \`templated-wobblie\` Wobblie wobblie to \`.agents/wobblies/templated-wobblie/WOBBLIE.md\`. It was generated by Wobblie from the [\`templated-wobblie\` example](https://github.com/wobblies-hq/wobblies-library/blob/main/wobblies/templated-wobblie/WOBBLIE.md).
...
https://github.com/wobblies-hq/wobblies-library/blob/main/README.md
...
${result.markerText}`);
  ...
  test('lists marker-backed PRs and reconciles edited-body install branches', async () => {
    ...
    const marker = createWobblieInstallMarker({
      version: 1,
      exampleId: 'templated-wobblie',
      sourceRepo: 'wobblies-hq/wobblies-library',
      sourceRef: 'test-ref',
