...
function createPullRequestBody(args: {
  ...
  lines.push(
    '## Summary',
    '',
    `This PR installs the \`${wobblieId}\` Wobblie wobblie to \`.wobblies/${wobblieId}/WOBBLIE.md\`. It was generated by Wobblie from the [\`${wobblieId}\` example](https://github.com/${SOURCE_REPO}/blob/main/wobblies/${wobblieId}/WOBBLIE.md).`,
    '',
